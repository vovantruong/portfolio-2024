    ...
    return (
        ...
        >
            <div className='h-full overflow-scroll noscrollbar-ui lg:flex' ref={containerRef}>
                {/* TEXT CONTAINER */}
                <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 xl:pr-0 xl:w-1/2">
                    {/* BIOGRAPHY */}
                    <div className="flex flex-col gap-12 justify-center">
                        <h1 className='font-bold md:text-3xl text-2xl uppercase'>Biography</h1>
                        <p className='text-lg'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facere, natus magnam. Necessitatibus autem consequatur recusandae.
                            Voluptates nam dolor quis cumque, ipsam autem facere amet repellat laudantium architecto numquam, saepe tenetur.</p>
                        <span className='italic text-sm'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.</span>
                    ...
                    <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
                        <motion.h1
                            className='font-bold md:text-3xl text-2xl uppercase'
                            initial={{ x: "-300px" }}
                                    ...
                                    <div className='w-1/2'>
                                        {
                                            index % 2 === 0 && (
                                                <>
                                                    ...
                                                    {/* COMPANY */}
                                                    <div className='p-1 bg-white rounded text-sm font-semibold w-fit ml-3'>
                                                        {item.company}
                                                    </div>
                                                </>
                                            )
